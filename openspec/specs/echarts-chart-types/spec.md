...
TestChartPage에서 다양한 ECharts 차트 유형을 테스트하고 시각화할 수 있도록 지원합니다.
...
#### Scenario: Themeriver chart preset selection
- **WHEN** 사용자가 "Themeriver Chart" preset을 선택하면
- **THEN** GraphView에 themeriver chart가 샘플 데이터와 함께 렌더링된다
